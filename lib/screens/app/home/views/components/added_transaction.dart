...
class AddedTransaction extends StatefulWidget {
  const AddedTransaction({Key? key}) : super(key: key);

  @override
  State<AddedTransaction> createState() => _AddedTransactionState();
}

class _AddedTransactionState extends State<AddedTransaction> {
   @override
  void initState() {
